...
**广的、累的，交给 AI。** 翻页、海量浏览、按硬条件粗筛、查重、攒够一批存成 PDF。这些只耗耐心、不靠品味的活，交给不会累的机器。

**准的、要眼光的，你自己来。** 谁值得约、谁在注水，由最懂这个岗的人盯着那叠筛过的短名单拍板。AI 不替你下这个判断，它只是让你不必为了下判断先翻三百份。

**JD 是你俩中间那把尺。** 每看完一批，你说清楚谁行、为什么行，谁不行、卡在哪。这些话写回 JD，下一轮 AI 照着更准的画像去捞。几轮下来，候选人会肉眼可见地往你要的方向收。
